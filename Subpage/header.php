    ...
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
    		...
    		<li class="dropdown mega-dropdown active">
			    <a class="color1" href="#" class="dropdown-toggle" data-toggle="dropdown">Đồ nữ<span class="caret"></span></a>				
			...
			<li class="dropdown mega-dropdown active">
			    <a class="color2" href="#" class="dropdown-toggle" data-toggle="dropdown">Đồ nam<span class="caret"></span></a>				
...
<ul>
			...
			<li><a class="color3" href="product.php">Sản phẩm</a></li>
